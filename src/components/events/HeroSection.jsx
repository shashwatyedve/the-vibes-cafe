...
//           <line x1="30" y1="16" x2="30" y2="44" stroke="#F8F4E9" strokeWidth="1.5"
...
//     >
//       <span className="text-xs tracking-widest uppercase font-medium" style={{ color: "#6F4E37", opacity: 0.6 }}>
//         Scroll
//       </span>
//       <motion.div
...
//   const bgY = useTransform(scrollY, [0, 500], [0, 60]); // subtle parallax on bg
...
//           {/* Heading */}
//           <motion.h1
//             className="leading-[1.08] font-bold"
//             style={{
...
//                 <span className="text-xl font-bold" style={{ color: "#3E2723" }}>{s.value}</span>
//                 <span className="text-xs font-medium tracking-wide" style={{ color: "#6F4E37", opacity: 0.7 }}>{s.label}</span>
//               </div>
//             ))}
//           </motion.div>
...
//           >
//             <motion.button
//               className="px-8 py-3.5 rounded-full text-sm font-bold tracking-wide text-white relative overflow-hidden"
//               style={{
...
//         style={{
//           background: "linear-gradient(to bottom, rgba(248,244,233,0) 0%, rgba(248,244,233,0.7) 100%)",
//         }}
//       />

//       {/* ── Keyframes for any extra CSS ── */}
//       <style>{`
